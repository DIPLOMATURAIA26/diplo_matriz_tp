...
Periodo de supervisión consolidado analizado: ${uploadYear}`;
  ...
  // On first load or whenever year/thresholds/datasets change, compute banks list
  useEffect(() => {
...
Periodo de supervisión consolidado analizado: ${selectedYear}`;
  ...
  const handleRegenerateReport = async () => {
    ...
    try {
      ...
      if (isSupabaseConfigured && supabase && data.report) {
        supabase
          .from("risk_reports")
          .upsert({
            year: year,
          ...
          .then(({ error }) => {
            if (error) {
              ...
              console.log("Report synchronized with Supabase successfully.");
            }
          });
      }
